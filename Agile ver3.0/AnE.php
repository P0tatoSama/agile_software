...
<div style="padding-left:80px">
  <h2>Location Category by Attraction & Entertainment</h2>
<div class="dropdown1">
...
<?php
		$query = "SELECT * FROM location WHERE Location_Category = 'Attraction and Entertainment' ORDER BY Location_Name ASC";
